      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="index.php?cont=North America">Amerique du Nord</a>
            <a class="dropdown-item" href="index.php?cont=South America">Amerique du Sud</a>
            <a class="dropdown-item" href="index.php?cont=Africa">Afrique</a>
            <a class="dropdown-item" href="index.php?cont=Oceania">Oceanie</a>
            <a class="dropdown-item" href="index.php?cont=Antarctica">Antarcique</a>
          </div>
        </li>
      </ul>
